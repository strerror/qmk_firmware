...
// #define LEADER_KEY_STRICT_KEY_PROCESSING    // Disables keySecode filtering for Mod-Tap and Layer-Tap keycodes. Eg, if you enable this, you would need to specify MT(MOD_CTL, KC_A) if you want to use KC_A.
