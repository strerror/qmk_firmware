...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [_FL] = {
        ...
        _______,    BLUE, _______,   GREEN, _______,  ORANGE,  ORANGE, _______, _______, _______, _______, _______,                               GRAY,
        _______, _______, _______,                   _______,                            _______,  YELLOW, _______, _______,             _______, GRAY, _______
    },
    [_ML] = {
