...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    // Added spacecadet code from <google search in qmk> for the shifts and hyper for ctrl
    [_KL] = LAYOUT(
        KC_ESC,            KC_F1,          KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,        KC_F12,           KC_PSCR, KC_SLCK, KC_PAUS,
        KC_GRV,            KC_1,           KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,       KC_EQL,  KC_BSPC, KC_INS,  KC_HOME, KC_PGUP,
        KC_TAB,            KC_Q,           KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,       KC_RBRC, KC_BSLS, KC_DEL,  KC_END,  KC_PGDN,
        ...
        MT(MOD_HYPR,KC_NO),TD(TD_LGUI_ML), KC_LALT,                   KC_SPC,                             KC_RALT, TT(_FL), TD(TD_APP_YL), KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ...
    [_FL] = LAYOUT(
        ...
        _______, _______, TG(_ML), TG(_GL),  TG(_YL), TG(_VL), _______, _______,  _______,  ROUT_FM, ROUT_TG, ROUT_VD, ROUT_VI, _______, KC_MSTP, KC_MPLY, KC_VOLU,
    ...
    [_ML] = LAYOUT(
        ...
        _______, KC_BTN4, KC_BTN3, KC_BTN5, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_WH_U,
        _______, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_WH_D,
    ...
    // "Default" layout (bar caps replacement) for gaming purposes
    [_YL] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,           KC_PSCR, KC_SLCK, KC_PAUS,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_INS,  KC_HOME, KC_PGUP,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,  KC_END,  KC_PGDN,
        ...
        // KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                            KC_UP,
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, TG(_YL),   KC_APP,  KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    /*
    [X] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [_FL] = {
        _______,   CORAL,   CORAL, _______, _______,   CORAL,   CORAL, _______, _______,   CORAL, _______,   CHART,   CHART,          TEAL,    GOLD,   GOLD,
        ...
        _______,    BLUE, _______,   GREEN, _______,  ORANGE,  ORANGE, _______, _______, _______, _______, _______,                               CHART,
        _______, _______, _______,                   _______,                            _______,  YELLOW, _______, _______,             _______, CHART, _______
    },
    [_ML] = {
        _______,    BLUE,    BLUE,   BLUE, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
        _______,    BLUE,    BLUE,   BLUE, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MAGENT,
        _______,    BLUE,    GOLD,   BLUE,  MAGENT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MAGENT,
        _______,    GOLD,    GOLD,   GOLD,  MAGENT, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______,  GREEN, _______, _______, _______, _______, _______, _______, _______, _______,                            GOLD,
        _______,  YELLOW, _______,                  _______,                            _______,  YELLOW, _______, _______,          GOLD,    GOLD,    GOLD
    },
    [_GL] = {
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______,  PURPLE,   GREEN,   GREEN, _______,    CYAN, _______,  PURPLE,  PURPLE, _______, _______, _______, _______, _______,
        _______,   GREEN,   GREEN,   GREEN,  PURPLE, _______, _______, _______, _______, CYAN,   _______, _______, _______,
        _______,    CYAN,   GREEN,  PURPLE,   GREEN,    CYAN, _______,   GREEN, _______, _______, _______, _______,                            _______,
        _______, _______, _______,                   _______,                            _______, YELLOW,  _______, _______,          _______, _______, _______
    },
    [_VL] = {
    ...
    [_YL] = {
        // _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, PURPLE,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                            _______,
